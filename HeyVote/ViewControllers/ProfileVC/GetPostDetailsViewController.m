...
@implementation GetPostDetailsViewController
...
-(void)callWebService{
    ...
    if (interNetCheck==YES ) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            NSMutableURLRequest *requestPost =[NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://www.heyvote.com/WebServices/HeyVoteService.svc/Posts/GetPostById_N4"]];
                ...
                if (error) {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        ...
                        if (dic == nil) {
                            ...
                            NSMutableArray * neeeewVal = [[NSMutableArray alloc]init];
                            
                            [neeeewVal addObject:[dic valueForKey:@"GetPostById_N4Result"]];
                            
                            NSLog(@"hjfshjfhs%@",newwVal);
                            
                            [globalArray addObject:[neeeewVal firstObject]];
...
(NSIndexPath *)indexPath{
    ...
    if (globalArray.count >0) {
        ...
        if ([[[globalArray valueForKey:@"PostType"] objectAtIndex:indexPath.section] integerValue] == 1) {
            ...
            if ([locationName isEqual:[NSNull null]]) {
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //    HashViewController *myVC = (HashViewController *)[storyboard instantiateViewControllerWithIdentifier:@"HashViewController"];
    //
